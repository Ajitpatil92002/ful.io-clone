export const Background_Upper = () => {
    return (
      <>
        <svg
          className="backgroundbrbox opacity-90  absolute top-0 right-[12vw] hidden w-[40%] overflow-hidden max-w-3xl -mt-96 lg:block  -mr-80 lg:w-[40%] lg:right-[10vw] xl:right-[16vw]"
          viewBox="0 0 818 815"
  ...
  export const Background_lowwer = () => {
    return (
      <>
        <svg
          className="absolute left-0 hidden lg:block max-w-sm -ml-64 left-svg"
          viewBox="0 0 423 423"
          xmlns="http://www.w3.org/2000/svg"
          xmlnsXlink="http://www.w3.org/1999/xlink"
        >
